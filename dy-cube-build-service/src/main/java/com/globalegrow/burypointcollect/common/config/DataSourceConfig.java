package com.globalegrow.burypointcollect.common.config;
...
@Configuration
@MapperScan(basePackages = "com.globalegrow.burypointcollect.mapper", sqlSessionTemplateRef  = "sqlSessionTemplate")
