...
public class AppDopamineReportOrderQuotaConfigJson {
    ...
    public void generate() throws Exception {
        ...
        rule.setReportName("BTS_ZAFUL_DOPAMINE_APP_ORDER");
        rule.setDescription("zaful APP 多巴胺 推荐报表");
        ...
        reportKafkaConfig.setBootstrapGroupId("dy_bts_dopamine_report_order");
        reportKafkaConfig.setReportStrapServers("172.31.35.194:9092,172.31.50.250:9092,172.31.63.112:9092");
        reportKafkaConfig.setReportDataTopic("dy_bts_dopamine_report");
