...
/**
 * GB app 首页瀑布流规则2019-02-27
 */
public class AppGBIndexRecommendConfigJson {
    ...
    public void generate() throws Exception {
        ...
        btsFilter4.setValueFilter("recommend_home");
        ...
        rule.setDescription("GB APP 首页瀑布流推荐报表");
        ...
        reportKafkaConfig.setBootstrapGroupId("dy_bts_gb_app_index_recommend_report");
        reportKafkaConfig.setReportStrapServers("172.31.35.194:9092,172.31.50.250:9092,172.31.63.112:9092");
        reportKafkaConfig.setReportDataTopic("dy_bts_gb_app_index_recommend_report");
    ...
    private void quota(List<ReportQuotaFieldConfig> reportQuotaFieldConfigs) {
        ...
        af_view_productFilter.setValueFilter("af_sku_click");
