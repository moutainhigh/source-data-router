...
public class GbDataToEs {
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"0"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"1"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"2"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"3"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"4"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"5"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"6"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"7"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"8"})}, groupId = "gb-report")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "${log-source}", partitions = {"9"})}, groupId = "gb-report")
