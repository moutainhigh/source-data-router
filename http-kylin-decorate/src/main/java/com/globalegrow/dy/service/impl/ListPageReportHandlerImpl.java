...
@Service
public class ListPageReportHandlerImpl implements ListPageReportHandler {
    ...
    @Override
    @Cacheable(cacheNames = "listpage_report_count_cache", key = "#listPageReportParameterDto.getCacheKey()")
    public ReportPageDto reportCount(ListPageReportParameterDto listPageReportParameterDto, DyReportKylinConfig dyReportKylinConfig,String resolvedString,ReportPageDto mapReportPageDto) {
