...
public class MD5CipherUtil {
    ...
    public static String objToJsonThenMd5(Object o) throws Exception {
        return generatePassword(JacksonUtil.toJSon(o));
    }
  ...
  /*  public static void main(String[] args) {
        String pwd1="admin";
        String pwd2="";
        MD5CipherUtil cipher = new MD5CipherUtil();
